...
function viewCreate(){
    let Page = html`<section class="createPage">
...
async function onCreate(event){
    ...
    await post('/data/albums', {name, imgUrl, price, releaseDate, artist, genre, description}, sessionStorage.getItem('accessToken'));
